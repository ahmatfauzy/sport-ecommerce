    ...
    <section id="kategori" class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-6">
                ...
                @php
                // Prefer accessor image_url; fallback to a generated placeholder if null
                $catImage = $category->image_url ?? 'https://placehold.co/400x400/F3F4F6/374151?text=' . urlencode($category->name);
                @endphp
