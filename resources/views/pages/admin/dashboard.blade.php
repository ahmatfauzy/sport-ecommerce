    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <a href="/admin/categories" class="flex items-center p-4 bg-green-50 rounded-lg hover:bg-green-100 transition">
                ...
                <a href="/admin/orders" class="flex items-center p-4 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition">
