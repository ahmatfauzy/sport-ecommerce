...
<head>
    ...
    <title>Daftar Akun - Seventeen Sports</title>
    ...
    <div class="min-h-screen flex items-center justify-center pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-md w-full bg-white p-8 md:p-10 rounded-xl shadow-lg" data-aos="fade-up">
            ...
            <div class="text-center mb-8">
                <img src="{{ asset('images/seventeen.png') }}" alt="Logo"
            ...
            <form class="space-y-5" action="/register" method="POST"> 
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        <label for="terms" class="text-gray-700">Saya setuju dengan
                            <a href="#" class="font-medium text-black hover:underline">Syarat & Ketentuan</a>
                        </label>
                    </div>
                </div>
